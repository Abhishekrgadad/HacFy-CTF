  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          <source
            src="https://cdn.pixabay.com/vimeo/147535484/matrix-5793.mp4?width=1280&hash=4e8e4f03f3797d8f9a6c45d44aef14e9e852c4d1"
            type="video/mp4"
          />
        </video>
      </div>
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <p className="text-xl sm:text-2xl text-cyan-400 mb-8 font-cyber">
